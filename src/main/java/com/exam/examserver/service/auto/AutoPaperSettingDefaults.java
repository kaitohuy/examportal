...
public final class AutoPaperSettingDefaults {
    ...
    public static List<AutoGenStepDTO> defaultSteps() { return defaultExamSteps(); }

    public static List<AutoGenStepDTO> defaultExamSteps() {
    ...
    public static List<AutoGenStepDTO> defaultPracticeSteps() {
        List<AutoGenStepDTO> defaults = new ArrayList<>();
